<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="RdcPlanning.aspx.cs" Inherits="customs_code_RdcPlanning" %>
      ...
      <telerik:GridTemplateColumn UniqueName="TemplateColumn" HeaderText="No.">
        ...
        <HeaderStyle Width="30px" />
                        ...
                        <telerik:GridBoundColumn DataField="PickupTime" HeaderText="Pickup Time" UniqueName="PickupTime"
                              ...
                              <telerik:GridBoundColumn DataField="UserName" HeaderText="Created By" UniqueName="UserName"
                                 FilterControlWidth="60px">
                                <HeaderStyle Width="115px" />
                            </telerik:GridBoundColumn>
