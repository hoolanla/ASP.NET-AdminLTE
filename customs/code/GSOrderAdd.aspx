...
<%--    <script src="scriptpages/GSOrderAdd.js" type="text/javascript"></script>--%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <table width="100%" border="0" cellspacing="10" cellpadding="10" class="table-main-form">
    <tbody>
      ...
      <td>Check days</td>
      <td>
        <div style="display:inline-block; margin-right:5px; width:60px; "><input type="text" name="txtCheckDay" id="txtCheckDay" maxlength="3" size="3" value="0" onchange="checkDayToEndDate();"></div>
        <div style="display:inline-block; width:150px; "><p id="end_date" name="end_date" >End date:</p></div>
      </td>
      </tr>
      <tr>
      	<td>RN No.</td>
...
<textarea name="txtRemark" id="txtRemark"></textarea></td>
      ...
      <tr>
        ...
        <td><table width="500" border="0" id="tOrder" class = "table table-hover">
          <thead>
            <tr>
              <th width="50">No.</th>
      ...
      <tr>
        <td>&nbsp;</td>
        <td><table width="130" border="0">
          <tbody>
            <tr>
              <td><input type="submit" name="submit" id="submit" value="Confirm" class='ui-button ui-widget ui-corner-all'></td>
              <td><input type="reset" name="reset" id="reset" value="Cancel" class='ui-button ui-widget ui-corner-all'></td>
            </tr>
          </tbody>
        </table></td>
      </tr>
