<%@ Page Title="" Language="C#" MasterPageFile="~/Home.master" AutoEventWireup="true" CodeFile="RdcReceiveList.aspx.cs" Inherits="RdcReceiveList" %>
      ...
      <telerik:GridTemplateColumn UniqueName="TemplateColumn" HeaderText="No.">
        ...
        <HeaderStyle Width="30px" />
                           ...
                           <telerik:GridBoundColumn DataField="ID" HeaderText="ID" UniqueName="ID"
                            ...
                            <telerik:GridBoundColumn DataField="GSOrderNo" HeaderText="GSOrder No" UniqueName="GSOrderNo"
                        ...
                        <telerik:GridBoundColumn DataField="MTBranchName" HeaderText="Branch" UniqueName="MTBranchName"
                              ...
                              <telerik:GridBoundColumn DataField="PickupDate" HeaderText="Pickup Date" UniqueName="PickupDate"
                                 FilterControlWidth="60px">
                                <HeaderStyle Width="115px" />
                            </telerik:GridBoundColumn>

                              <telerik:GridBoundColumn DataField="PickupTime" HeaderText="Pickup Time" UniqueName="PickupTime"
                                 FilterControlWidth="60px">
                                <HeaderStyle Width="115px" />
                            </telerik:GridBoundColumn>
                       ...
                       <%--             <asp:LinkButton ID="BookButton" runat="server" Text="DETAIL" OnClientClick='<%# String.Format("openConfirmationWindow({0}); return false;", Eval("ID")) %>'
                                        ...
                                        <asp:LinkButton ID="LinkButton1" runat="server" Text="DETAIL" href=<%# String.Format("RDCReceiveDetail.aspx?ID={0}", Eval("ID")) %> ></asp:LinkButton>
